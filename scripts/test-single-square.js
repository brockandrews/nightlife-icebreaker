...
const { executeHandshakeEvaluation, claimSquareSelection } = require("../src/lib/game-engine");
...
async function runSimulation() {
  ...
  console.log(`✓ Player A candidate squares:`, result.playerA.candidateSquares.map(s => s.promptText));
